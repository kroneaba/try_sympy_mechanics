...
#
# Optimierungsvariablen: a1, a2, a3, a4, a5, xB, yB0
#
...
parameters = [xE, Fc, u] # constant parameters
optvariables = [a1, a2, a3, a4, a5, xB, yB0] # optimization variables
nopt = len(optvariables) # number of optimization variables
parameters_vals = [200., 50., 10.] # values of constants
optvariables_vals = [] # initial guess

yEi = -90. # initial vertical position of poimt E (or D)
yEe = yEi + 4.*parameters_vals[-1] # final vertical position of poimt E (or D)
...
b_xB = (25,45)
b_yB0 = (0, 20)
bnds = (b_a1, b_a2, b_a3, b_a4, b_a5, b_xB, b_yB0)
...
def StartPosition_E(x, args):
    ...
    constraintVal = eqPDy_func(*arguments_all) - yEi
    constraintVal /= yEi
...
def EndPosition_E(x, args):
    ...
    qi = fsolve(mech_con, qi, args = (arguments)) # find positions
    arguments_all = hstack((qi, arguments))     # States, input, and parameters
    constraintVal = eqPDy_func(*arguments_all) - yEe
    constraintVal /= yEe
    return constraintVal
